...
Route::group( ['middleware' => 'auth' ], function()
{
	...
	Route::get('editmanage_address', 'UserController@editmanage_address');
    Route::get('editmanage_address/{id}', 'UserController@editmanage_address');
    Route::post('updatemanage_address', 'UserController@editmanage_address');
	...
	Route::get('orders_list_pharmacist', 'UserController@orders_list_pharmacist');
	Route::get('orders_Details_pharmacist/{id}', 'UserController@orders_Details_pharmacist');
	Route::get('addproduct_pharmacy_list','UserController@addProductPharmacy');
	Route::get('add_product_pharmacy','UserController@add_product_pharmacy');
    Route::post('addproduct_pharmacy','UserController@addProductPharmacy_process');
	Route::get('menuItem','UserController@menuItem');
	Route::post('add_product_pharmacy_data','UserController@addProductPharmacyData');
