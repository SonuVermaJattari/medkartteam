...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Uses  name should not be blank";
	$flag=0;
	}
...
{	
	...
	$sqlqry="update filter_uses set name='$name' " ;
	if(isset($new_image_name)!='')
	{
	$sqlqry.=", images='$new_image_name'";
	}
	$sqlqry.=",`status`='$r3' , `sortorder`= '$sort'  where id='$eid' ";
	$successful=$DB->executupdate($sqlqry);

	if($successful)
	{
		$msg="Uses  Updated Successfully";	
	}
}
}
$QRY="select * from filter_uses where id='$eid'";
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <!--<li><a href="javascript:void(0);">Uses  Management</a></li>-->
                        <li class="active">Uses </li>
                    </ol>
                </section>
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Uses </h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <div class="box-body" >
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="number" name="sort" class="form-control" placeholder="Eg: 1" value="<?php echo $web['sortorder'];?>"  required />
                                        </div>
                                       ...
                                       <!--  <div class="form-group">
                                           <label>Uses  Code</label>
                                            <input name="color_code" ctype="text" Uses ="38" value="<?php echo $web['color_code'];?>" class="form-control color" maxlength="100"  />
