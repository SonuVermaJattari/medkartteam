...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update filter_form set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update filter_form set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from filter_form where id='$act'");
		}
}
		
		$mqry="select * from filter_form";
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    ...
                    <th><h3 align="center">Product Form Name</h3></th>
                   <!-- <th><h3 align="center">Product Form Code</h3></th>-->
                ...
                <tr>
                  ...
                  <!--  <td><center><?php echo $web['color_code'];?></center></td>
                    ...
                    <td><center><?php if( $web['images']!="") { ?><img src="../uploaded_client_color/<?php echo $web['images'];?>" width="20" />&nbsp; <?php } echo $web['images'];?></center></td>-->
                     ...
                     <td><center><a href="edit_form.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>
