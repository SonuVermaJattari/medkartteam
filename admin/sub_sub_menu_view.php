...

{
		...
		mysql_query("update sub_sub_menu set status='0' where id='$act'");
...

{
...

		{
			...
			mysql_query("update sub_sub_menu set status='1' where id='$act'");
...

{
...

		{
			...
			mysql_query("delete from sub_sub_menu where id='$act'");
		...
		$mqry="select * from sub_sub_menu where sub_menu='$services_name' order by sort ";
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <h1>
                     ...
                     Sub Sub Menu <small><?php echo $array[$array_sub[$services_name]['menu']].' ('.$array_sub[$services_name]['sub_menu'].') '; ?></small>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            ...
            <thead>
                ...
                <tr>
					...
					<th class="nosort" style="text-align:center"><h3>Sub sub Menu</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                ...
                <tr>
					...
					<td style="text-align:center;"><?php echo $web['sub_sub_menu'];?></td>

					<td style="text-align:center"><?php echo $web['link'];?></td>

                    <td style="text-align:center;"><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>

                    <td style="text-align:center;"><a href="sub_sub_menu_edit.php?eid=<?php echo $web['id'].'&&menu='.$array_sub[$services_name]['menu'];?>" title="Edit">Edit</a></td>
