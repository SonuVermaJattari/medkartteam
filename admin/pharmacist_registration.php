...
//{
		...
		//{
			...
			//mysql_query("delete from wt_header_img where id='$act'");
...
//}
		...
		$mqry="select * from user where fix='PID-' ";
...
<html>
    ...
    <head>
        ...
        <title>Registration | Data Tables</title>
    ...
    <body class="skin-blue">
        ...
        <div style="float:right;"><input type="Submit" name="Activate" value="Activate" class="btn-sm"> <input type="Submit" name="Dectivate" value="Deactivate" class="btn-sm"> </div>
            ...
            <thead>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                ...
                <tr>
                 ...
                 <!--   <td><center><a href="pharmacist_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>-->

                    <td align="center"><input type="checkbox" value="<?php echo $web['id']; ?>" name="bb[]" id="bb[]"></td>
<td><a href="pharmacist_edit.php?eid=<?php echo $web['id'];?>&&fix=PID-" title="Edit"><?php if( $web['productsstatus']=='1'){echo "Active";} else {echo "Deactive";}?></a></td>
