            ...
            <thead>
				...
				<th class="nosort"  style="display:none;"><h3>Sr.No.</h3></th>
                  <th class="nosort"><h3>Sr.No.</h3></th>
                    ...
                    <th class="nosort"><h3>Total Products</h3></th>
                    <th class="nosort"><h3>View</h3></th>
                </tr>
            </thead>
              <tbody>
               <?php 
				...
				<td style="display:none;"><?php echo $count; ?></td>
                    ...
                    <td><?php 
                      ...
                      <td><?php echo '('.$menu['count(id)'].')'; ?></td>
                    <td><a href="products_view.php?menu=<?php echo $menu['menu']; ?>&&sub_menu=<?php echo $menu['sub_menu']; ?>&&sub_sub_menu=<?php echo $menu['sub_sub_menu']; ?>" title="View">View</a></td>
                </tr>
            <?php $count++; }?>
            </tbody>
        </table>
