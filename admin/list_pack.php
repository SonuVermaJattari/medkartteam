...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update packing set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update packing set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from packing where id='$act'");
		}
}
		$q=(int)$_GET['q'];
		$mqry="select * from packing where type='$q'";
                ...
                <tr>
                  ...
                  <!--  <td><center><?php echo $web['color_code'];?></center></td>
                    ...
                    <td><center><?php if( $web['images']!="") { ?><img src="../uploaded_client_color/<?php echo $web['images'];?>" width="20" />&nbsp; <?php } echo $web['images'];?></center></td>-->
                     ...
                     <td><center><a href="edit_pack.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>
