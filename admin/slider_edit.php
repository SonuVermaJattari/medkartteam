...
if(empty($erromsg)){
	...
	$sqlqry="update `slider` set `text1`='$text11',`text2`='$text21', sort='$sort1', status='$r3',link='$link1' " ;
...
$QRY="select * from `slider` where id='$eid'";
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
									...
									<button type="button" name="View" style="float: right;" onClick=" window.location ='slider.php';" class="btn btn-primary">Add <?php echo $res_name; ?></button>
                                </div><!-- /.box-header -->
                                ...
                                <form role="form" method="post" name="form" enctype="multipart/form-data">
									...
									<div class="box-body" >
                                        ...
                                        <div class="form-group">
											<label>Text 1</label>
											<input type="text" name="text1" class="form-control" value="<?php echo $web['text1']; ?>" placeholder="Enter text1..." required/>
										</div> 
										<div class="form-group">
											<label>Text 2</label>
										...
										<!--<div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="sort" class="form-control" value="<?php echo $web['sort']; ?>" placeholder="Enter ..." required/>
                                        </div>
