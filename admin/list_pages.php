...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update cms set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update cms set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from cms where id='$act'");
		}
}
		
		$mqry="select * from cms ";
		$mqry.=" order by id ";
...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?php echo $DB->projectname();  ?>| pages Tables</title>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">Pages Management</a></li>
		...
		<div id="tableheader">
            ...
            <span class="details">
        		...
        		<div class="btn-reset"><a class="button blue" href="add_pages.php">ADD Pages</a></div>
        	</span>
        </div>
        <section>
        <form name="myform" method="post" action="">
        <div style="float:right;">  <input type="Submit" name="Delete" class="btn-sm" value="Delete" onclick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }"></div>
      	<div class="clearfix"></div>
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    <th class="nosort"><h3>Sr.No.</h3></th>
                    <th  style="display:none;" ><h3>id</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
                    ...
                    <td style="display:none;"><?php echo $web['id'];?></td>
                    <td class="name"><a href="../pages.php?val=<?php echo $web['title'];?>" target="_blank" title="Previous Page"><?php echo $web['title'];?></a></td>
       				<td><a href="edit_pages.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
