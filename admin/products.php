        ...
        <div class="col-lg-9" style=" float:none; margin:0 auto;"> 
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" name="form" enctype="multipart/form-data">
              ...
              <!-- /.box-body -->
                <div class="form-group">
                    <label>Your Previous Product</label>
                    <table class="table">
                      <tr>
                      ...
                      <?php $just=mysql_query("select * from `products` where `product_user_id` ='$user_id' "); 
                        while($most=mysql_fetch_array($just)){  ?>
                          <tr>
                            <td><input type="checkbox" name="checkbox[]" value="$most['name'];" name="chkbox[]"></td>
                            <td><?php   echo  $most['name']; ?></td>
                            <td>sss<?php   echo  $username; ?></td>
                          </tr>
                      <?php } ?>
                    </table>
                </div>  
