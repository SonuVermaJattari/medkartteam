...
if(isset($_POST['submit'])){
	...
	if(empty($erromsg)){
		...
		/*	$text2=mysql_escape_string($text2);
			...
			$query="INSERT INTO `blog_id`(`id`, `title`, `sort`, `status`) VALUES (NULL,'$text1','$sort','$r3')";
...
<div class="row">
<!-- left column --><div class="box-body" >
<div class="col-lg-10">
...
<button type="submit" class="btn btn-primary pull-right" >Blog Categories View</button>
</form>
</div>
</div>
</div>
...
<input type="text" name="text1" class="form-control" value="" placeholder="Enter categories..." required/>
</div> 
<!--
<div class="form-group">
<label>Text 2</label>
<input type="text" name="text2" class="form-control" value="<?php echo $po2; ?>"  placeholder="Enter text2..." required/>
</div>
<div class="form-group">
<label>Text 3</label>
<input type="text" name="text3" class="form-control" value="<?php echo $po3; ?>"  placeholder="Enter text3..." required/>
</div>-->
<!--<div class="form-group">
<label>Link</label>
<input type="text" name="link" class="form-control" value="<?php echo $po4; ?>"  placeholder="Enter link..." required/>
</div>-->
...
<input type="number" name="sort" class="form-control" min='1' placeholder="Eg: 1" value=""  required />
</div>
