...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update solt set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update solt set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from solt where id='$act'");
		}
}
		$q=(int)$_GET['q'];
		$mqry="select * from solt ";
		$mqry.=" order by sort";
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                     Solt Type Management
                        
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="javascript:void(0);">Solt Type Management</a></li>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                ...
                <th class="nosort" ><h3 align="center">S.No</h3></th>
                    <th class="nosort" style="display:none;"><h3 align="center">S.No</h3></th>
                    <th><h3 align="center"> Name</h3></th>
                   <!-- <th><h3 align="center">Brand Code</h3></th>-->
                ...
                <tr>
                  ...
                  <!--  <td><center><?php echo $web['color_code'];?></center></td>
                    ...
                    <td><center><?php if( $web['images']!="") { ?><img src="../uploaded_client_color/<?php echo $web['images'];?>" width="20" />&nbsp; <?php } echo $web['images'];?></center></td>-->
                     ...
                     <td><center><a href="edit_solt.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>
