...
if(isset($_POST['submit']))
{
	...
	$sqlqry="INSERT INTO `filter_age` ( `id` , `name` , `status` , `sortorder` )VALUES (NULL , '$name', '$r3', '$sort')" ;
	
	$successful=$DB->executupdate($sqlqry);
	
	if($successful)
	{
		$msg="Age  Inserted Successfully";	
	}
	}
}
                                        ...
                                        <div class="form-group">
                                         ...
                                         <!--  <div class="form-group">
                                           <label> Color Code</label>
                                            <input name="color_code"   ctype="text" age ="38" class="form-control color" maxlength="100"  />
