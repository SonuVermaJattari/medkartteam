...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update social_links set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update social_links set status='1' where id='$act'");
		}
}
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Social | Data Tables</title>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">Footer Management</a></li>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    ...
                    <th class="nosort"><h3 align="center">Title Name</h3></th>
                    <th class="nosort"><h3 align="center">Url</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
                    ...
                    <td><center><?php echo ucfirst($web['social']);?></center></td>
                    <td><center><?php echo $web['social_link'];?></center></td>
