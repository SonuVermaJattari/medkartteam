...
if(isset($_POST['submit']))
{
	...
	$sqlqry="INSERT INTO `filter_gender` ( `id` , `name` , `status` , `sortorder` )VALUES (NULL , '$name', '$r3', '$sort')" ;
	
	$successful=$DB->executupdate($sqlqry);
	
	if($successful)
	{
		$msg="Gender Inserted Successfully";	
	}
	}
}
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Add Gender </h3>
                                </div><!-- /.box-header -->
                                <?php if($erromsg!=''){ ?>
                               <!-- Alert-->
                                ...
                                <form role="form" method="post" name="form" enctype="multipart/form-data">
                                    <div class="box-body" >
                                        <div class="form-group">
                                         ...
                                         <!--  <div class="form-group">
                                           <label> Color Code</label>
                                            <input name="color_code"   ctype="text" Gender ="38" class="form-control color" maxlength="100"  />
                                     ...
                                     <!--   <div class="form-group">
                                            ...
                                            <p class="help-block">Image must be 20*20.</p>
                                        </div>-->
