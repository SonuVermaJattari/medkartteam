...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Discount name should not be blank";
	$flag=0;
	}
...
{	
	...
	$sqlqry="update filter_discount set name='$name' " ;
...
$QRY="select * from filter_discount where id='$eid'";
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <!--<li><a href="javascript:void(0);">Discount Management</a></li>-->
                                    ...
                                    <div class="box-body" >
                                       ...
                                       <!--  <div class="form-group">
                                           <label>Discount Code</label>
                                            <input name="color_code" ctype="text" weight="38" value="<?php echo $web['color_code'];?>" class="form-control color" maxlength="100"  />
