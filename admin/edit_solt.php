...
{	
	...
	$sqlqry="update solt set name='$name' " ;
	if(isset($new_image_name)!='')
	{
	$sqlqry.=", images='$new_image_name'";
	}
	$sqlqry.=",`status`='$r3' , `sort`= '$sort', `text`= '$editor1'   where id='$eid' ";
...
$QRY="select * from solt where id='$eid'";
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Solt Type</h3>
                                </div><!-- /.box-header -->
