...
if(isset($_POST['Delete']) && $bb!='')
{
	...
	$menu1=(int)$_GET['menu'];		
	$sub_menu1=(int)$_GET['sub_menu'];		
	$sub_sub_menu1=(int)$_GET['sub_sub_menu'];		
	if($sub_sub_menu1!=0){
		$were="menu='$menu1' AND sub_menu='$sub_menu1' AND sub_sub_menu='$sub_sub_menu1'";
	}elseif($sub_menu1!=0){
		$were="menu='$menu1' AND sub_menu='$sub_menu1'";
	}elseif($menu1!=0){
		$were="menu='$menu1'";
	}
	$mqry="select * from products where $were";
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
					...
					<?php 
				 if($sub_sub_menu1!=0){
					echo $menu_array[$menu1].'('.$submenu_array[$sub_menu1].')'.'('.$subsubmenu_array[$sub_sub_menu1].')';
				}elseif($sub_menu1!=0){
					echo $menu_array[$menu1].'('.$submenu_array[$sub_menu1].')';
				}elseif($menu1!=0){
					echo $menu_array[$menu1];
				}
		...
		<div id="tableheader">
            ...
            <span class="details">
				...
				<button type="button" name="View" style="float: right;" onClick=" window.location ='products.php';" class="btn btn-primary">Add Products</button>
        	</span>
        </div>
        <section>
            ...
            <thead>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
				...
				<td style="display:none;"><?php echo $count; ?></td>
                   ...
                   <td><a href="price.php?eid=<?php echo $web['id'];?>" title="price">Add</a> / <a href="list_price.php?q=<?php echo $web['id'];?>" title="price">View</a></td>
             	    <td><?php if( $web['status']=='1'){echo "Active";} else {echo "Deactive";}?></td>
                      <td><a href="products_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
