...
include 'includes/functions.php';
		...
		$mqry="select * from is_subscribed order by id desc";
?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title>Flying Cakes | Data Tables</title>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    ...
                    <th class="nosort"><h3 align="center">Date</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
                    ...
                    <td><center><?php  $yadate=$web['date'];echo $new_date = date('d-M-Y', strtotime($yadate));?></center></td>
