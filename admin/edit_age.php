...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Age should not be blank";
	$flag=0;
	}
...
{	
	...
	$sqlqry="update filter_age set name='$name' " ;
...
$QRY="select * from filter_age where id='$eid'";
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Age </h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <div class="box-body" >
                                       ...
                                       <!--  <div class="form-group">
                                           <label>Age  Code</label>
                                            <input name="color_code" ctype="text" Age ="38" value="<?php echo $web['color_code'];?>" class="form-control color" maxlength="100"  />
