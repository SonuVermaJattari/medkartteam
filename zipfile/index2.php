...
<div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
                 ...
                 <?php } ?>
	<?php /*?><div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">

					<img class="ls-bg" src="images/home_slide_11.jpg" alt="">

					<div class="ls-l layer_8" style="left: 578px; top: 75px;" data-ls="offsetxin: 60; easingin: easeOutBack; durationin: 650;">Our PHARMACISTS</div>
					<div class="ls-l layer_9" style="left: 568px; top: 126px;" data-ls="offsetxin: 60; delayin: 150; easingin: easeOutBack; durationin: 650;">Are Ready to Help You!</div>
				...
				<div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
					...
					<img class="ls-bg" src="images/home_slide_12.jpg" alt="">

					<div class="ls-l layer_8" style="left: 738px; top: 75px;" data-ls="offsetxin: 60; easingin: easeOutBack; durationin: 650;">Get 10% Off</div>
					<div class="ls-l layer_9" style="left: 732px; top: 126px;" data-ls="offsetxin: 60; delayin: 150; easingin: easeOutBack; durationin: 650;">For Reorders</div>
                ...
                <div class="ls-slide" data-ls="transition2d: 10, 27, 63, 67, 69;">
					...
					<img class="ls-bg" src="images/home_slide_13.jpg" alt="">

					<div class="ls-l layer_8" style="left: 738px; top: 75px;" data-ls="offsetxin: 60; easingin: easeOutBack; durationin: 650;">Safe Medicine</div>
					<div class="ls-l layer_9" style="left: 732px; top: 126px;" data-ls="offsetxin: 60; delayin: 150; easingin: easeOutBack; durationin: 650;">At Best Prices</div>
           ...
           <div class="" style="position:absolute; width:85%; bottom: 40px;padding: 29px 40px 40px 40px; background-color: #032c58;">
										...
										<form class="clearfix search" action="search.php" method="get" onSubmit="return serach();">
<h2 style="margin-bottom:0px; color:#fff;">Search from thousands of products available</h2>

<input type="text" name="search" id="search" tabindex="1" autocomplete="off" onKeyUp="showResult(this.value)"  placeholder="Search for Medicines Products" class="alignleft fld">
...
</select><button type="submit" value="Search" class="homered"><i class="icon-search"></i></button>
								...
								<?php
								  ...
								  ?>
                                    ...
                                    <?php /*?><div class="col-sm-4">
										...
										<a href="#" class="banner" style="padding:30px 0 0;">
										...
										<a href="#" class="banner" style="padding:30px 0;">
...
<?php } ?>
									...
									<?php /*?><blockquote>
										...
										<p>Ut tellus dolor, dapibus eget, elementum vel, cursus elefiend, elit. Aenean auctor wisi et urna. Aliquam erat volutpat.</p><div class="author_info"><b>Nikki, Boston</b></div>
