...
if(isset($_POST['submit'])){
	...
	$msg=$DB->img_mul($_FILES,'gallery','room_img','1');
	$erromsg=$DB->error();
}
?>
<!DOCTYPE html>
				...
				<div class="col-lg-9" style=" float:none; margin:0 auto;">
					...
					<div class="box box-primary">
						<div class="box-header">
							...
							<button type="button" name="View" style="float: right;" onClick=" window.location ='gallery_view.php';" class="btn btn-primary">View Gallery</button>
