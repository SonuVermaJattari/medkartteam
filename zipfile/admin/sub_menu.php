...
$editor1=mysql_real_escape_string($editor1);
	/*if(empty($menu)){
		$erromsg="plz Select menu....";
	}if(empty($sub_menu)){
		$erromsg="plz Enter Sub menu....";
	}*/if($link=='sub sub menu'){
		$link='0';
	}
	if(empty($erromsg)){
		$query="INSERT INTO `sub_menu` (`id`, `menu`, `sub_menu`, `link`, `text`, `Products_name`, `ban_img`, `img`, `sort`, `status`)VALUES (NULL, '$menu', '$sub_menu','$link','$editor1','$Products_name' ,'$new_image_name', '$image_name', '".$_REQUEST['sort']."', '$r3')";
                               ...
                               <!--./Alert-->
                                ...
                                <form role="form" method="post" name="form" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<option value="" class="hidden">--Select Menu--</option>
										...
										<!--<div id="new_select">-->
											<div class="form-group">
												...
												<input type="text" name="sub_menu" class="form-control" placeholder="Eg: SUB_MENU ...." reqiured />
											</div>
