...
if(isset($_POST['submit']))
{
	...
	$sqlqry="INSERT INTO `filter_form` ( `id` , `name` , `status` , `sortorder` )VALUES (NULL , '$name', '$r3', '$sort')" ;
	
	$successful=$DB->executupdate($sqlqry);
	
	if($successful)
	{
		$msg="Product Form Inserted Successfully";	
	}
	}
}
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Product Form</li>
                    </ol>
                </section>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <!--  <div class="form-group">
                                           <label> Color Code</label>
                                            <input name="color_code"   ctype="text" thickness="38" class="form-control color" maxlength="100"  />
