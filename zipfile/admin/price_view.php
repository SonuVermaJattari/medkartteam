...
if(isset($_POST['Dectivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update review set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update review set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from review where id='$act'");
		}
}
    ...
    <body class="skin-blue">
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
              ...
              <tbody>
              <?php
			  $mqry="SELECT price.p_id,products.name FROM `price` left join products on price.p_id=products.id GROUP by price.p_id, price.p_menu";
			  ...
			  while($row=mysql_fetch_array($fetch)) { ?>
                <tr>
                    ...
                    <td align="center"><a href="list_price.php?q=<?php echo $row['p_id']; ?>">View Review</a></td>
                </tr>
               <?php $count++; }?>
            </tbody>
        </table>
