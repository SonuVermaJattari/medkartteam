...
if(isset($_POST['Inactive']) && $bb!='')
{
		foreach($bb as $act)
		{
		mysql_query("update menu set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update menu set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from menu where id='$act'");
		}
}
		
		$mqry="select * from menu ORDER BY sort";
		 //where mark='main' ";
    ...
    <body class="skin-blue">
		...
		<div id="tableheader">
            ...
            <span class="details">
        		...
        		<div class="btn-reset"><button type="button" name="View" style="float: right;" onClick=" window.location ='menu.php';" class="btn btn-primary">Add Menu</button></div>
        	</span>
        </div>
        <section>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
					...
					<th class="nosort" style="text-align:center"><h3>Menu Name</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td style="text-align:center"><img src="../<?php  echo $web['menu_icon'];?>" style="background-color: black;" /> <?php echo $web['menu']; ?></td>
					<td style="text-align:center"><?php echo $web['link']=='0'?'Sub menu':$web['link'];?></td>
                    <td style="text-align:center"><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td style="text-align:center"><a href="menu_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
