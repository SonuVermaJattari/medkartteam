...
$services_name=(int)$_GET['q'];
	if(isset($_POST['Inactive']) && $bb!='')
	{
		foreach($bb as $act)
		{
			...
			mysql_query("update afterSlider_view set status='0' where id='$id'");
		}
	}
	...
	if(isset($_POST['Activate']) && $bb!='')
	{
		...
		{	
			list($id,$name)=explode('@',$act);
			mysql_query("update afterSlider_view set status='1' where id='$id'");
		}
	}
	...
	if(isset($_POST['Delete']) && $bb!='')
	{
		...
		{
			list($id,$name)=explode('@',$act);
			mysql_query("delete from afterSlider_view where id='$id'");
			unlink($name);
		}
	}
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">After Slider View</a></li>
		...
		<div id="tableheader">
            ...
            <span class="details">
				...
				<div style="float:right; display:none;" class="btn-reset"><button type="button" name="View" style="float: right;" onClick=" window.location ='afterSlider_view.php';" class="btn btn-primary">After Slider View</button></div>
        	</span>
        </div>
        <section>
            ...
            <thead>
                <tr>
                    <th style="text-align:center"><h3>Sr.No.</h3></th>
                     <th style="text-align:center; display:none;"><h3>Sr.No.</h3></th>
...
-->                </tr>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
                    ...
                    <td style="text-align:center"><a href="afterSlider_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
