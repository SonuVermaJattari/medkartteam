...
if(isset($_POST['Inactive']) && $bb!='')
{
		...
		mysql_query("update testimonials set status='0' where id='$id'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		...
		{
			list($id,$name)=explode('@',$act);
			mysql_query("update testimonials set status='1' where id='$id'");
		}
}
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Testimonials | Data Tables</title>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                      Testimonials <small>Edit/view</small>
                    </h1>
                    <ol class="breadcrumb">
		...
		<div id="tableheader">
            ...
            <span class="details">
        		...
        		<div class="btn-reset"><button type="button" name="View" style="float: right;" onClick=" window.location ='testimonials.php';" class="btn btn-primary">Testimonials</button>
				</div>
        	</span>
        </div>
        <section>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    <th><h3>Sr.No.</h3></th>
					<th class="nosort"><h3>Sort Order</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td class="name"><?php echo $web['sort'];?></td>
                    <td><?php echo $web['name'];?></td>
          			<!--<td><img src="../<?php echo $web['image'];?>" width="50" /></td>  -->
				 <td><?php echo $web['msg'];?></td>
				 <!--  <td><?php echo $web['long_description'];?></td>
                   <td><?php echo $web['image'];?></td>-->
             	    <td><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td><a href="testimonials_edit.php?eid=<?php echo $web['id']; ?>" title="Edit">Edit</a></td>
