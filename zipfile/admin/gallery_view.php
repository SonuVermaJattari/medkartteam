...
$room_id=(int)$_GET['eid'];		
		$mqry="select * from room_img where gallery_id='1'";
    ...
    <body class="skin-blue">
                ...
                <section class="content-header">
                  ...
                  Gallery Images
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">Gallery Images</a></li>
		...
		<div id="tableheader">
            ...
            <span class="details">
				...
				<button type="button" name="View" style="float: right;" onClick=" window.location ='gallery.php';" class="btn btn-primary">Add Gallery </button>
        	</span>
        </div>
        <section>
