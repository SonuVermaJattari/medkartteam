...
if(isset($_POST['Inactive']) && $bb!='')
{
		foreach($bb as $act)
		{
			$arr=explode(',',$act);
			$idwe=$arr[0];
			mysql_query("update blog  SET  status='0' where id='$idwe'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			...
			$idwe=$arr[0];
			//$img=$arr[1];
			mysql_query("update blog  SET  status='1' where id='$idwe'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			...
			mysql_query("delete from blog where id='$idwe'");
		}
}
		
		$mqry="select * from blog where blog_id='$service_id' ORDER BY sort";
...
<html>
    <head>
       ...
       <script type="text/javascript">
        ...
        <![endif]-->
		<style>
		.width-new p { text-align: justify;
width: 480px;
overflow: hidden;
white-space: nowrap;
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                      <?= $services_name;?> Blog View <small></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a href="javascript:void(0);"><?= $services_name;?> Blog View</a></li>
		...
		<div id="tableheader">
            ...
            <span class="details">
        		...
        		<div class="btn-reset"><a class="button blue" href="blog_add.php?q=<?php echo $_GET['q'].'&&name='.$_GET['name']; ?>">ADD <?= $services_name;?></a></div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
					...
					<th class="nosort" style="text-align:center"><h3>Title</h3></th>
					<th class="nosort" style="text-align:center"><h3>Description</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td style="text-align:center"><div class="width-new"><?php echo $web['msg']; ?></div></td>
					<td style="text-align:center"><img src="../<?php echo $web['img'];?>" style="width:100px;" /></td>
                    <td style="text-align:center"><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td style="text-align:center"><a href="blog_add_edit.php?eid=<?php echo $web['id'].'&&';?>q=<?php echo $_GET['q'].'&&name='.$_GET['name']; ?>" title="Edit">Edit</a></td>
