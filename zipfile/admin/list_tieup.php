...

{
...

		{
			...
			mysql_query("update user set status='0' where id='$act'");
...

{
		...
		$mqry="select * from user where fix='MID-' ";
...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">Tieup</a></li>
        ...
        <div style="float:right;"><input type="Submit" name="Activate" value="Activate" class="btn-sm"> <input type="Submit" name="Dectivate" value="Deactivate" class="btn-sm"> <input type="Submit" name="Delete" value="Delete" class="btn-sm" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" ></div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            ...
            <thead>
                ...
                <tr>
					 ...
					 <th style="display:none;" ><h3 align="center">S.no</h3></th>

                    <th ><h3 align="center">S.no</h3></th>

                     <th class="nosort"><h3 align="center">Uid</h3></th>

                    <th class="nosort"><h3 align="center">Name</h3></th>

                    <th class="nosort"><h3 align="center">Email</h3></th>

                     <th class="nosort"><h3 align="center">Phone</h3></th>
					<th class="nosort"><h3 align="center">Status</h3></th>
                    

                   <th class="nosort"><h3>Edit</h3></th>

                    <th class="nosort"><h3>Select</h3></th>
					<th class="nosort"><h3 align="center">products status</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                ...
                <tr>
					...
					<td style="display:none;"><center><?php echo $count;?></center></td>

                    <td><center><?php echo $count;?></center></td>

                    <td><center><?php echo ucfirst($web['fix'].$web['prefix'].$web['post']);?></center></td>

                    <td><center><?php echo $web['title'].' '.ucfirst($web['fname']).' '.$web['lname'];?></center></td>

                      <td><center><?php echo $web['email'];?></center></td>

                      <td><center><?php echo $web['phone'];?></center></td>
                      
						

                    <td><?php if( $web['status']=='1'){echo "Active";} else {echo "Deactive";}?></td>

                    <td><center><a href="tieup_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>

                    <td align="center"><input type="checkbox" value="<?php echo $web['id']; ?>" name="bb[]" id="bb[]"></td>
<td><a href="pharmacist_edit.php?eid=<?php echo $web['id'];?>&&fix=MID-" title="Edit"><?php if( $web['productsstatus']=='1'){echo "Active";} else {echo "Deactive";}?></a></td>
