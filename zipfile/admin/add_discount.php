...
if(isset($_POST['submit']))
{
	...
	$sqlqry="INSERT INTO `filter_discount` ( `id` , `name` , `status` , `sortorder` )VALUES (NULL , '$name', '$r3', '$sort')" ;
                                        ...
                                        <div class="form-group">
                                         ...
                                         <!--  <div class="form-group">
                                           <label> Color Code</label>
                                            <input name="color_code"   ctype="text" Discount="38" class="form-control color" maxlength="100"  />
