...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Product Form name should not be blank";
	$flag=0;
	}
...
{	
	...
	$sqlqry="update filter_form set name='$name' " ;
	...
	if($successful)
	{
		$msg="Product Form Updated Successfully";	
	}
}
}
$QRY="select * from filter_form where id='$eid'";
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <!--<li><a href="javascript:void(0);">Product Form Management</a></li>-->
                               ...
                               <!--./Alert-->
                                ...
                                <form role="form" method="post" name="form" enctype="multipart/form-data">
                                    <div class="box-body" >
                                       ...
                                       <!--  <div class="form-group">
                                           <label>Product Form Code</label>
                                            <input name="color_code" ctype="text" thickness="38" value="<?php echo $web['color_code'];?>" class="form-control color" maxlength="100"  />
