...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Gender should not be blank";
	$flag=0;
	}
...
{	
	...
	$sqlqry="update filter_gender set name='$name' " ;
...
$QRY="select * from filter_gender where id='$eid'";
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <!--<li><a href="javascript:void(0);">Gender  Management</a></li>-->
                                    ...
                                    <div class="box-body" >
                                       ...
                                       <!--  <div class="form-group">
                                           <label>Gender  Code</label>
                                            <input name="color_code" ctype="text" Gender ="38" value="<?php echo $web['color_code'];?>" class="form-control color" maxlength="100"  />
