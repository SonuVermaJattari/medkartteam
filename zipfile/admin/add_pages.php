...
if(isset($_POST['submit']))
{
	...
	if($flag=='1'){	
		$sqlqry="INSERT INTO `cms` (`id`, `title`, `content`) VALUES (NULL, '$tname', '$editor1')";
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                               ...
                               <div style="padding:5px 10px 0 10px;">
                                ...
                                <?php } ?>
                                <form action="list_pages.php" method="post" enctype="multipart/form-data">
<button type="submit" class="btn btn-primary pull-right" >Pages View</button>
</form>
                               <!--./Alert-->
                                <!-- form start -->
