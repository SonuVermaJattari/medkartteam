...
$services_name=$_GET['q'];
if(isset($_POST['Inactive']) && $bb!='')
{
		foreach($bb as $act)
		{
		mysql_query("update `blog_id` set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update `blog_id` set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from `blog_id` where id='$act'");
		}
}
		
		$mqry="select * from `blog_id` ORDER BY sort";
		 //where mark='main' ";
...
<html>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                     Blog categories view <small></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="javascript:void(0);">Blog categories view</a></li>
		...
		<div class="btn-reset"><a class="button blue" href="blog_ctgry.php">ADD Blog Categories</a></div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    <th style="text-align:center"><h3>Sr.No.</h3></th>
					<th  class="nosort" ><h3>sortorder</h3></th>
				<!--	<th class="nosort" style="text-align:center"><h3>Text 1</h3></th>
					<th class="nosort" style="text-align:center"><h3>Text 2</h3></th>
					<th class="nosort" style="text-align:center"><h3>Text 3</h3></th>-->
					<th class="nosort" style="text-align:center"><h3>Name</h3></th>
					<th class="nosort" style="text-align:center"><h3>Status</h3></th>
                    <th class="nosort"style="text-align:center"><h3>Edit</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td ><?php echo $web['sort'];?></td>
				<!--	<td style="text-align:center"><?php echo $web['text1'];?></td>
					<td style="text-align:center"><?php echo $web['text2'];?></td>
					<td style="text-align:center"><?php echo $web['text3'];?></td>-->
					<td style="text-align:center"><?php echo $web['title'];?></td>
					<!--<td style="text-align:center" ><img src="../images/slider/<?php echo $web['img'];?>"  style="width:150px; height:70px;"  /></td>-->
                    <td style="text-align:center"><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td style="text-align:center"><a href="blog_ctgry_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
