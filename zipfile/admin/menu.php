...
//print_r($_POST);
	if(empty($erromsg)){
		$query="INSERT INTO `menu` (`id`, `menu`, `link` , `text`, `sort`, `status`,menu_icon) VALUES (NULL, '$menu' ,'$link' ,'$editor1','$sort', '$r3','$new_image_name')";
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">mene</h3><button type="button" name="View" style="float: right;" onClick=" window.location ='menu_view.php';" class="btn btn-primary">View Menu</button>
                                </div><!-- /.box-header -->
                                <?php if($erromsg!=''){ ?>
                               <!-- Alert-->
                                ...
                                <form role="form" method="post" name="form" enctype="multipart/form-data">
                                    <div class="box-body" >
										...
										<div class="form-group">
                                            ...
                                            <input type="text" name="menu" class="form-control" placeholder="Eg: home,about us,service ...." required />
                                        </div>
