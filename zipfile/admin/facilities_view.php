...
if(isset($_POST['Inactive']) && $bb!='')
{
		foreach($bb as $act)
		{
		mysql_query("update add_our_services set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update add_our_services set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from add_our_services where id='$act'");
		}
}
		
		$mqry="select * from add_our_services ORDER BY sort";
		 //where mark='main' ";
    ...
    <body class="skin-blue">
		...
		<div id="tableheader">
            ...
            <span class="details">
				...
				<div class="btn-reset"><button type="button" name="View" style="float: right;" onClick=" window.location ='facilities.php';" class="btn btn-primary">Add Facilities</button></div>
        	</span>
        </div>
        <section>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
					...
					<th  style="text-align:center" ><h3>sort</h3></th>
					<th style="text-align:center"><h3>Facilities</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td style="text-align:center"><?php echo $web['service_name'];?></td>
					<td style="text-align: center;"><img src="../<?php echo $web['img'];?>" width="30px"/></td> 
                    <td style="text-align:center"><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td style="text-align:center"><a href="facilities_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
