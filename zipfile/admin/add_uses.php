...
if(isset($_POST['submit']))
{
	...
	if($name=='')
	{
	$erromsg="Uses should not be blank";
	$flag=0;
	}
	...
	$sqlqry="INSERT INTO `filter_uses` ( `id` , `name` , `status` , `sortorder` )VALUES (NULL , '$name', '$r3', '$sort')" ;
	
	$successful=$DB->executupdate($sqlqry);
	
	if($successful)
	{
		$msg="Uses Inserted Successfully";	
	}
	}
}
					 ...
					 <!-- general form elements -->
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Add Uses </h3>
                                </div><!-- /.box-header -->
                                <?php if($erromsg!=''){ ?>
                               <!-- Alert-->
                                        ...
                                        <div class="form-group">
                                         ...
                                         <!--  <div class="form-group">
                                           <label> Color Code</label>
                                            <input name="color_code"   ctype="text" Uses ="38" class="form-control color" maxlength="100"  />
