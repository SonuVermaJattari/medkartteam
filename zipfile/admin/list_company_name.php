...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update company_name set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update company_name set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from company_name where id='$act'");
		}
}
		$q=(int)$_GET['q'];
		$mqry="select * from company_name ";
		$mqry.=" order by sort";
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="javascript:void(0);">company name Management</a></li>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
                    ...
                    <th style="display:none;" class="nosort"><h3 align="center">S.No</h3></th>
                ...
                <tr>
                  ...
                  <!--  <td><center><?php echo $web['color_code'];?></center></td>
                    ...
                    <td><center><?php if( $web['images']!="") { ?><img src="../uploaded_client_color/<?php echo $web['images'];?>" width="20" />&nbsp; <?php } echo $web['images'];?></center></td>-->
                     ...
                     <td><center><a href="edit_company_name.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></center></td>
