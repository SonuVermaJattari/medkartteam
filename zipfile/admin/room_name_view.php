...
if(isset($_POST['Inactive']) && $bb!='')
{
		foreach($bb as $act)
		{
		mysql_query("update room set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("update room set status='1' where id='$act'");
		}
}
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysql_query("delete from room where id='$act'");
		}
}
		$mqry="SELECT * from room";
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                      <?php echo $room;?> <small></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="javascript:void(0);"> <?php echo $room;?> </a></li>
		...
		<div id="tableheader">
            ...
            <span class="details">
        		...
        		<div class="btn-reset"><!--<button type="button" name="View" style="float: right;" onClick=" window.location ='room_name.php';" class="btn btn-primary">Add Room's</button>--></div>
        	</span>
        </div>
        <section>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
                <tr>
					...
					<th class="nosort"><h3>Name</h3></th>
                    
                    <th class="nosort"><h3>Image</h3></th>
					<th class="nosort"><h3>Home Display</h3></th>
			  ...
			  while($web=mysql_fetch_array($fetch)) { ?>
                <tr>
					...
					<td class="name"><?php echo $web['type'];?></td>
                    
                 	<td><a href="room_img.php?eid=<?php echo $web['id'];?>" title="Edit">Add</a> / <a href="room_img_view.php?eid=<?php echo $web['id'];?>" title="Edit">View</a><!--<img src="../<?php echo $web['img'];?>" width="50" />--></td>  
				 	
                     <td><?php if( $web['home_display']=='1'){echo "Yes";} else {echo "No";}?></td>
             	    <td><?php if( $web['status']=='1'){echo "Active";} else {echo "Inactive";}?></td>
                    <td><a href="room_name_edit.php?eid=<?php echo $web['id'];?>" title="Edit">Edit</a></td>
