  ...
  <div class="bottom_part">
    ...
    <div class="sticky_part">
      ...
      <div class="container">
       ...
       <a href="index.php" class="logo"> <img src="<?php echo BASEURL; ?>images/dawakhana-logo.png" alt=""> </a> 
            ...
            <?php if(($_SESSION['fix']=='PID-') && (isset($_SESSION['fix']))){ ?>
            ...
            <div class="col-lg-8 col-sm-8" >
              ...
              <div class="align_right" style="margin-top: 20px; margin-bottom: 20px;">
                ...
                <div class="login" style="font-size: 18px;">
                  ...
                  <?php  if(empty($_SESSION['pemail'])) {  ?>

                  <a  href="<?php echo BASEURL; ?>/plogin.php">Login</a> | <a  href="<?php echo BASEURL; ?>/pregister.php">Register</a>

                  <?php }else{  ?>

                  <a  href="<?php echo BASEURL; ?>Pharmacist/myaccount.php"><?php echo $_SESSION['ptitle'].' '.$_SESSION['pfirstname'].' '.$_SESSION['plastname']; ?></a> | <a  href="<?php echo BASEURL; ?>logout.php">Sign Out</a>
            ...
            <div class="col-lg-6 col-sm-6" style="border-right:1px solid #ddd;">
              ...
              <div class="align_right" style="margin-top: 20px; margin-bottom: 20px;">
                ...
                <div class="login" style="font-size: 18px;">
                  ...
                  <a  href="<?php echo BASEURL; ?>login">Login</a> | <a  href="<?php echo BASEURL; ?>register.php">Register</a>

                  <?php }else{  ?>

                  <a  href="<?php echo BASEURL; ?>myaccount.php"><?php echo $_SESSION['title'].' '.$_SESSION['firstname'].' '.$_SESSION['lastname']; ?></a> | <a  href="<?php echo BASEURL; ?>logout">Sign Out</a>
                ...
                <?php
                  ...
                  <div class="shopping_cart dropdown">
                    ...
                    <div class="animated_item">
                      ...
                      <div class="clearfix sc_product"> <a href="<?php echo BASEURL; ?><?php echo $resProducts['menu']=='1'?'product_details-medicine.php?q='.$resProducts['id']:'product_details.php?q='.$resProducts['id']; ?>" class="product_name"><?php echo $resProducts['name']; ?></a>
                   ...
                   <?php /*?> <!--/ .animated_item-->
                    ...
                    <div class="animated_item">
                      ...
                      <div class="clearfix sc_product"> <a href="#" class="product_thumb"><img src="<?php echo BASEURL; ?>images/sc_img_2.jpg" alt=""></a> <a href="#" class="product_name">Lorem Ipsum Dolor Sit Amet...</a>
                    ...
                    <div class="animated_item">
                      ...
                      <div class="clearfix sc_product"> <a href="#" class="product_thumb"><img src="<?php echo BASEURL; ?>images/sc_img_3.jpg" alt=""></a> <a href="#" class="product_name">Nemo Enim Ipsam <br>
                    ...
                    <div class="animated_item"> <a href="<?php echo BASEURL; ?>shopping_cart.php" class="button_grey">View Cart</a> <a href="<?php echo BASEURL; ?>checkout.php" class="button_blue">Checkout</a> </div>
            ...
            <div class="col-lg-2 col-sm-2 col-xs-12 align_center">
              ...
              <p class="uph">Upload Prescription</p>
           	...
           	<ul class="theme_menu submenu">
                ...
                <?php if($sub_web['link']=='0'){ ?>
                 ...
                 <ul class="theme_menu submenu">
					...
					<li><a href="<?php echo BASEURL; ?><?php echo $sub_sub_web['link']=='New Page'?'about.php?q='.$sub_sub_web['id'].'&&menu='.$sub_sub_web['enum']:
