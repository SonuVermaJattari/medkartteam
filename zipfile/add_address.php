...
if(isset($_SESSION['email'])){
	...
	if(isset($_POST['Edit'])){
		...
		if($DB->executupdate("INSERT INTO `address`( `u_id`, `title`, `fname`, `lname`, `address`, `street`, `city`, `state`, `pincode`, `phone`) VALUES ('$u_id', '$title', '$fname', '$lname', '$address', '$street', '$city', '$state', '$pincode', '$phone')")){
...
<title>The medkart | Add Address</title>
