...
<!doctype html>
<html lang="en">
<?php if($_GET['val']!="") { $val_id=$_GET['val'];  } ?>
<head>
		<!-- Basic page needs
		============================================ -->
		<title><?php echo $val_id; ?></title>
		<meta charset="utf-8">
...
<?php   $detail=mysql_query("select * from cms where title='$val_id'");
     $ft_detail=mysql_fetch_assoc($detail); ?>
			<!-- - - - - - - - - - - - - - Page Wrapper - - - - - - - - - - - - - - - - -->
			...
			<div class="secondary_page_wrapper">
				...
				<div class="container">
					...
					<ul class="breadcrumbs">
						...
						<li><?php echo $ft_detail['title']; ?></li>
					...
					<div class="row">
						...
						<main class="col-md-12 col-sm-12">
							...
							<h1><?php echo $ft_detail['title']; ?></h1>
								
							<div class="theme_box clearfix">
								<?php echo $ft_detail['content']; ?>
								<?php /*?><img src="images/about_img_1.jpg" class="alignleft" width="310" alt="">
